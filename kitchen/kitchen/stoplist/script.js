...
function goHome() {
 ...
 let message = `🧾 ${headerDict.title[lang] || headerDict.title.ru} \n\n`;
...
if (actionSelect) {
 ...
 const checklist = document.querySelectorAll('#stop_list input[type="checkbox"]');
let selectedItems = [];
...
checklist.forEach((item) => {
 ...
 document.querySelectorAll('#stop_list input[type="checkbox"]').forEach(cb => cb.checked = false);
 const commentField = document.querySelector('textarea.comment');
